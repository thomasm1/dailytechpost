...
public class PostHardcodedService {
	...
	static {
		posts.add(new Post(++idCounter,did,date,author,cat3,title, post,blogcite));
		posts.add(new Post(++idCounter,"did1","date", "author","cat3", "title", "post", "blogcite"));
		posts.add(new Post(++idCounter,"did2","date", "author","cat3", "title", "post", "blogcite"));
		posts.add(new Post(++idCounter,"did3","date", "author","cat3", "title", "post", "blogcite")); 
