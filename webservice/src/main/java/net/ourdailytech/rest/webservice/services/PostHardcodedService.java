...
public class PostHardcodedService {
	...
	static {
		posts.add(new Post(++idCounter,did,date,author, monthOrder,cat3,title, post,blogcite, username));
		posts.add(new Post(++idCounter,"did1","date1", "author","monthOrder1","cat3", "title1", "post1", "blogcite1", "user2"));
		posts.add(new Post(++idCounter,"did2","date2", "author2","monthOrder","cat3", "title2", "post2", "blogcite2", "user2"));
		posts.add(new Post(++idCounter,"did3","date3", "author3","monthOrder3","cat33", "title3", "post3", "blogcite3", "user2")); 
