...
/*
  blogpost5 = `
 <p class="firstparagraph">It turns out that data is unevenly distributed between sectors:</p>
...
*/
  ...
  <p class="firstparagraph">A curious path of punctuated advancement due to insufficient memory and cpu power, characterized late 20th century A.I. development. For a period of ten years, then the GPU,  each step of Deep Learning development has been marked by long lulls interrupted by rapid growth with each successive technological tools: Dr. Geoff Hinton's single-layered A.I. algorithm gained brief fame, to lose all interest for ten years, and A.I. research no longer advanced due to insufficient memory and cpu power--for a period of ten years, then along came the GPU.  And then Alex Khreshinski's famous image-recognition competition-winning penmanship detector, which notably is still in use by the banking system. Also known as the "Cambrian Explosion", this event (and really just the algorithm) set off widespread advancements and speciation from the ANN, Neural Network, to a whole alphabet soup from Convolutional Neural Networks (CNN) <i>to far-reaching mutations of Reinforcement Learning</i>.<sup>2</sup>
  </p>
  ...
  <p>While Hinton and company aren't necessarily Mahatma Gandhi-like, their devotion to a science prioritized to humanity' service--free from monetary or other influence is admirable--no wonder their outlook on A.I.'s utility is so much brighter than that of Pessimist Elon Musk and company ... baah-humbug!
...
` ;
  ...
  [ /*
    { 
      ...
      cat3:'A.I.Now',
      title:'Training Data, Big and Beloved Data, Part II.<br />The Cambridge Analytica Regression Techniques',
      post:blogpost5,
     blogcite:blogcite5     },
    */
   { 
      ...
      title:'The Canadian Mafia:<br /> On the Good-Natured Vision of the Godfathers of A.I.', 
      post:blogpost4,
     blogcite:blogcite4     },
    { 
      id:'3',
      ...
      author:'by Thomas Maestas',
      cat3:'A.I.Now',
      title:'Training Data, Big and Beloved Data, Part I.<br />Big Data\s Most Notorious Rule-Breaker and Rule-Enforcer: A.I.',
      post:blogpost3,
     blogcite:blogcite3     }, 
   { 
    id:'2',
