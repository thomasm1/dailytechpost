...
var bloggerDec = function () {  
   /*
    var blogpost163 =   ` 
  <p class="firstparagraph">Technology is too often the scapegoat for problems with ... <i>anything</i>.  
  </p>
  <p class="quote">But there are limits to the supposedly life-changing magic of going offline. Smartphones are as central to the economy as cars and credit cards, and a lot of people have little meaningful opportunity to quit. <br />
  <br /> 
  ...
  `; 
      ...
      var url = [ 
        /*
          ...
          title: 'It\'s no Fair Scapegoating Tech for *Our* Bad Habits',
          post: blogpost163,
