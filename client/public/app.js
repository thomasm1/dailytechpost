...
(function() {
    ...
    var app = angular.module('app', ['ngRoute', 'ngCookies', 'ngResource', 'kendo.directives', 'firebase']);
    ...
    app.config(['$routeProvider', function($routeProvider) {
        ...
        .when('/home', {
          ...
          .when('/chartBlog',
              {templateUrl: '/welcome/chartBlog.html'})
           .when('/dataSource', 
              {templateUrl: '/layout/dataSource/dataSource.html'})
           ...
           .when('/gridBlog', 
              { templateUrl: '/welcome/gridBlog.html' })
