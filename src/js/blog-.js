console.log('blogger');
var bloggerModal = function(){
 
  blogpost6 = `
  <p class="firstparagraph"> 
  </p>
  <p class="quote">  </p>
 <p class="cite">1. <a href=" /" target="_blank"> </a></p>
 
  `

 
  blogpost5 =  `<p class="firstparagraph"> 
  </p>
  <p class="quote"> </p>
 <p class="cite">  <a href=" " target="_blank"> </a></p> 
  `
 
  blogpost4 =  `<p class="firstparagraph">"You Can Never Understand Everything, but You can Push Yourself to Understand the System"</br /><br />
...
Two subcommittees of the U.S. House Committee on Science, Space and Technology - for Research and Technology, and Oversight - will meet on May 8, a newly published notice reveals. The hearing is entitled "Leveraging Blockchain Technology to Improve Supply Chain Management and Combat Counterfeit Goods."<sup>1</sup></p>
<p>Here, the Science, Space, & Technology Committee <sup>2</sup> of Congress will be meeting This Tuesday, May 8th, hearing from Witnesses from Maersk (head of global trade digitization), UPS (global customs brokerage staff), and of course the good ol' Dept. of Homeland Security, and doubtless a platoon of lawyers! </p>
...
`
  ...
  [ 
    ...
    title:'3rd Generation Blockchain: How fast can the blockchain operate? Part III: : On the Importance of Being Earnest',
    post:blogpost4
     },
      { 
    id:'3',
    ...
    author:'by Thomas Maestas, MA',
    cat3:'Musing Blockchain',
    title:'3rd Generation Blockchain: How fast can the blockchain operate? Part II: : Speed Needs of the Supply Chain Management',
    post:blogpost3
  },
  { 
    id:'2',
...
<div id=18-05-02" class="     avr 18-03 -24"> 
<hr />  
...
document.getElementById("paragraph").innerHTML += cat; 
}
