...
`;
  blogpost13 = `
  <p class="firstparagraph"> <i>Now that 49% of American e-commerce passes through Amazon's gates, it's official: 50% market share signifies a hostile take-over of Amerian Culture.</i> From the remaining half of the Online Shopping pie goes to  the next top nine, 22%: 
 </p>
 <p class="quote">
  eBay (EBAY): 6.6%<br /><br />
