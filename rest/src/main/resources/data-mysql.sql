...
INSERT IGNORE  INTO users (userid, contacttype, cusurl, dashboardcode, email, firstname, isactive, lastname, organizationcode, password, usertype, username)
VALUES
...
INSERT IGNORE  INTO categories (id, description, name)
VALUES
...
INSERT IGNORE  INTO post_entity (id, author, blogcite, cat3, post_date, did, duration_goal, month_order, post, state, title, username, word_count, category_id)
VALUES
...
INSERT IGNORE  INTO comments (id, body, email, name, post_id)
VALUES
